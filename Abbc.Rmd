...
file_show <- read_excel("C:/Users/Amit R. Amin/Downloads/service.xlsx")
```
Row
-----------------------------------------------------------------------
...
```{r}
collapsibleTree(file_show, c("issue","root1","root2","root3","root4","root5","root6","root7","root8","root9","root10","root11","root12","root13","root14","root15", "root16","root17","root18","root19","root20"),
